<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="homepage.aspx.cs"
    Inherits="CafeTracking_1.homepage" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <section>
            <div class="container">
                ...
                <div class="row mt-5">
                    <div class="col-md-4">
                        <div class="card">
                            <img src="imgs/hot_drink3.jpg" class="card-img-top" alt="Espresso"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" placeholder="Your Name">
                        </asp:TextBox>
                        <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control mt-2" placeholder="Your Email">
                        </asp:TextBox>
                        <asp:TextBox ID="txtMessage" runat="server" TextMode="MultiLine" Rows="4"
                            CssClass="form-control mt-2" placeholder="Your Message"></asp:TextBox>
                        <asp:Button ID="btnSendMessage" runat="server" Text="Send Message"
                            CssClass="btn btn-primary mt-2" OnClick="btnSendMessage_Click" />
                        <asp:Button ID="btnShowReviews" runat="server" Text="Show Reviews"
                            CssClass="btn btn-primary mt-2" CausesValidation="false" OnClick="btnShowReviews_Click" />
                    </div>
        ...
        <div id="reviewsModal" class="modal">
            <div class="modal-content">
                <span class="close"
                    onclick="document.getElementById('reviewsModal').style.display='none'">&times;</span>
