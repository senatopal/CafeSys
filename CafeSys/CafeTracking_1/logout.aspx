<%@ Page Title="Logout" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="logout.aspx.cs"
    Inherits="CafeTracking_1.logout" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="logout-container">
            ...
            <div class="delete-account-section" id="deleteAccountsection" runat="server">
                ...
                <asp:TextBox ID="memberpassword" runat="server" TextMode="Password" />
                <br />
